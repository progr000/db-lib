...
namespace Maksym\Db\Contracts\MigrationSchema;

use Maksym\Db\Contracts\MigrationSchema\Common\SchemaColumn;
use Maksym\Db\Exceptions\DbException;
use Maksym\Db\Interfaces\PrepareFieldInterface;
